...
from career_agent_ai.app import app
...
@patch('career_agent_ai.api.jobs.orchestrator')
...
@patch('career_agent_ai.api.jobs.load_jobs')
...
@patch('career_agent_ai.api.jobs.get_job_by_id')
